...
class AspectRatioView(discord.ui.View):
    ...
    async def generate_image(self, interaction: discord.Interaction, width: int, height: int):
        ...
        # Dynamische Fortschrittsanzeige basierend auf Steps
        ...
        for i in range(1, 11):
            await asyncio.sleep(0.2 + steps * 0.01 + cfg * 0.02)  # skaliert Aufwand
            try:
        ...
        # Truncate nach 100 Zeichen: nur "[more info]" anzeigen
